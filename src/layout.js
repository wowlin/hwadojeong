...
export const secondRoom1DoorX = planRightLivingX + sideRoomW - interiorDoorW - 0.10;   // 계단실 쪽 벽에서 10cm 띄움
export const secondRoom2DoorX = secondRoom2X + 0.10;                                    // 계단실 쪽 벽에서 10cm 띄움
