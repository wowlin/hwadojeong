...
// 계단실 양쪽 내벽(거실|계단실 · 계단실|안방) — 중심 위치·두께를 1층/계단/다락 화면이 공유하는 단일 기준.
...
export const stairLowXWallX = livingInnerWallX - innerWallW / 2;              // 거실측 내벽 거실면
export const stairClearX = livingInnerWallX + innerWallW / 2;                 // 거실측 내벽 계단면(=계단실 안목 시작)
...
export const secondRoom1DoorX = planRightLivingX + firstLivingW - interiorDoorW - 0.10;   // 계단실 쪽 벽(1층 거실측 내벽면)에서 10cm 띄움
export const secondRoom2DoorX = secondRoom2X + 0.10;                                    // 계단실 쪽 벽(1층 안방측 내력벽면)에서 10cm 띄움
...
export const atticRoom1RearWindowX = planRightLivingX + (firstLivingW - atticRearWindowW) / 2;
