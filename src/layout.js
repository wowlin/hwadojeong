...
export const secondRoom1DoorX = planRightLivingX + sideRoomW - interiorDoorW;   // 계단실 쪽(방의 안방쪽 끝)에 붙임
export const secondRoom2DoorX = secondRoom2X;                                    // 계단실 쪽(방의 거실쪽 끝)에 붙임
