...
export const secondRoom1DoorX = planRightKitchenX + firstKitchenW - interiorDoorW - 0.70;   // 계단실 쪽 벽(1층 주방측 내벽면)에서 70cm 띄움
export const secondRoom2DoorX = secondRoom2X + 0.70;                                    // 계단실 쪽 벽(1층 안방측 내력벽면)에서 70cm 띄움
