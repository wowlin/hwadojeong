...
import {
  yzWallPrism, roofSlab,
} from './builders.js';
import {
  gableLongWallX, lowWall, horizontalWallWithGaps, verticalWallWithGaps,
  interiorDoorHorizontal, pocketDoorHorizontal, pocketDoorVertical, sideEntryDoor,
  frontFixSash, rearSlider, sideRearSlider, frontAwningSash, sideSash, awningSash,
} from './openings.js';
import {
  buildingW, buildingD, buildingBackZ, groundTopY, floorFinishH, deckFinishT, lotW,
  lotD, firstWallHeight, exteriorWall, interiorWall,
...
// ceilingFan·ceilingLight·coveLight는 ./fixtures.js로 이동(반복 소품 부품 라이브러리).
