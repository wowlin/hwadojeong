...
const _wBase = groundTopY + MAT_H, _wFh1 = 3.3, _wFh = 3.0, _wFh3 = 2.6;     // 1층 3.3 · 2층 3.0 · 3층 2.6(손님방 외벽 최저 2.4 = 바닥마감 0.2 뺀 값)
...
(() => {
  ...
  // 홈리프트(아리코 권장 캐빈 900×1280) 자리 표시 — 1·2·3층 수직정렬 샤프트. 세면대(뒤 외벽·高Z) 低X변에 붙여 세면대는 제자리 두고 옆에 벽 세워 만드는 자리. 기존 벽 무시하고 자리만 표시.
