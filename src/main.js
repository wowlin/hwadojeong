...
(() => {
  ...
  captureInto(s2Wall2Objects, () => {
    ...
    const corrX2 = liftX0 + liftW - 2.025;                    // 앞·뒤 프로젝트창 X중앙(창과 동일 출처)
    wallOutlet(corrX2, inZ0, oy, '+Z');                       // 앞 프로젝트창 아래(앞 외벽)
    label('프로젝트창 콘센트', corrX2, oy + 0.25, inZ0 + 0.2, 'mep');
    wallOutlet(corrX2, inZ1, oy, '-Z');                       // 층계참 뒤벽 프로젝트창 아래(뒤 외벽)
    label('프로젝트창 콘센트', corrX2, oy + 0.25, inZ1 - 0.2, 'mep');
  });
  ...
  captureInto(s2Wall3Objects, () => {
    ...
    wallOutlet(far3 - 0.2, inZ0, oy, '+Z');                          // 게스트룸1 앞벽 — 문쪽(옆벽 far3) 코너
    label('게스트룸1 콘센트', far3 - 0.2, oy + 0.25, inZ0 + 0.2, 'mep');
    const g2xL = inX1 - g2RoomW;                                     // 게스트룸2 복도측 옆벽(문쪽)
    wallOutlet(g2xL + 0.2, inZ0, oy, '+Z');                          // 게스트룸2 앞벽 — 문쪽(옆벽 gxL) 코너
    label('게스트룸2 콘센트', g2xL + 0.2, oy + 0.25, inZ0 + 0.2, 'mep');
