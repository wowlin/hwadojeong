...
export const s2F2SepWallT = 0.20;                   // 2층 계단실 분리 내력벽 두께 — 벽(floor2)·콘센트 좌표(outlets) 공유(§4-2)
export const s2F2Furn = { bedW: 2.0, bedD: 2.0, bedH: 0.4, drwD: 0.40, drwH: 0.80, bdgW: 2.0, bdgD: 0.70, bdgH: 2.0 };   // 2층 안방 가구 규격 — 그리기(floor2)·콘센트 좌표(outlets)·라벨 공유(§4-2)
export const s2FdColT = 0.3;      // 1층 정면 폴딩도어 양끝 기둥 굵기(3층 내하중 가정 300mm) — 외벽·외부콘센트·주방콘센트 공유(§4-2)
export const s2RGap = 4 * 0.8;     // 1층 우측 4짝 양미서기 개구 폭(짝 0.8×4) — 외벽·주방측 콘센트 공유
export const s2LGap = 4 * 0.68;    // 1층 좌측 폴딩창 2+2 개구 폭(짝 0.68×4) — 외벽·주방 콘센트 공유
