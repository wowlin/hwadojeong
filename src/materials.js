...
materials.waterHeater = new THREE.MeshLambertMaterial({ color: 0xf07316 });   // 전기온수기 본체(주황) — s1·s2 싱크대 하부장 공용
materials.cabinetDoor = new THREE.MeshLambertMaterial({ color: 0xd8c7a4, transparent: true, opacity: 0.32, side: THREE.DoubleSide, depthWrite: false });   // 싱크 하부장 문짝 — 반투명(안의 전기온수기가 비쳐 보이게). 몸통(sinkCabinet)과 같은 색
